            ...
            <div class="gap-6">
                ...
                <div class="p-4 mt-4 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                        <div class="justify-between items-center my-4">
                            ...
                            <br><br>
                            <div class="w-52 flex">
                                <a href="{{ route('gutenbergs.edit', $gutenberg->id) }}" class="w-auto mr-4 h-8 bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center">Edit</a>
