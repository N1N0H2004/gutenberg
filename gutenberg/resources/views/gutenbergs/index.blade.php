                ...
                @forelse($gutenbergs as $gutenberg)
                    <div class=" p-4 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                        <div class=" justify-between items-center">
                            ...
                            <br><br>
                            <div class="w-52 flex">
                                <a href="{{ route('gutenbergs.edit', $gutenberg->id)  }}" class="w-auto h-8 bg-white float-right text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md py-2 px-6 inline-flex items-center">Edit</a>
